...
def wish():
    ...
    if hour >= 0 and hour<12:
        speak("good morning sir i am virtual assistent How can I help you?")
    elif hour>=12 and hour<18:
        speak("good afternoon sir i am virtual assistent How can I help you?") 
    else:
        speak("good night sir i am virtual assistent How can I help you?")  
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "wikipedia" in query:
            ...
            about = "I am virtual assistent an A I based computer program but i can help you lot like a your close friend ! i promise you ! Simple try me to give simple command ! like playing music or video from your directory i also play video and song from web or online ! i can also entain you i so think you Understand me ! ok Lets Start "
            print(about)
            speak(about)
        elif "hello" in query or "hello My virtual assistent" in query or "hello AI" in query:
            hel = "Hello Hemant Sir ! How May i Help you.."
            print(hel)
            speak(hel)
        elif "your name" in query or "sweat name" in query:
            na_me = "Thanks for Asking my name my self ! virtual assistent"  
            print(na_me)
            speak(na_me)
